...
export const JWT_SECRET = 'mi_clave_secreta_muy_segura_2024'; // No se debería de hacer un hardcode de el secreto. Pero para el ejemplo se lo hara de esta forma
